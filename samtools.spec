...
Source0  : https://github.com/samtools/samtools/releases/download/1.21/samtools-1.21.tar.bz2
...
%prep
%setup -q -n samtools-1.21
cd %{_builddir}/samtools-1.21
pushd ..
cp -a samtools-1.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727476639
...
cp %{_builddir}/samtools-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/samtools/f1c054deb203002d65360e715d62b4ab454f82ee || :
cp %{_builddir}/samtools-%{version}/htslib-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/samtools/541760bf26f52ef94859789c9e91c4b2b0218baa || :
...
/usr/share/package-licenses/samtools/541760bf26f52ef94859789c9e91c4b2b0218baa
/usr/share/package-licenses/samtools/6c4957c5b4497597ff61a6a6cef7b08eacbc7731
/usr/share/package-licenses/samtools/f1c054deb203002d65360e715d62b4ab454f82ee
