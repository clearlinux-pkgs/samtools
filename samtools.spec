...
Source0  : https://github.com/samtools/samtools/releases/download/1.16.1/samtools-1.16.1.tar.bz2
...
%prep
%setup -q -n samtools-1.16.1
cd %{_builddir}/samtools-1.16.1
...
cp %{_builddir}/samtools-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/samtools/50cf0fe6339a24d238c57e77aa74deb891080ecd || :
cp %{_builddir}/samtools-%{version}/htslib-1.16/LICENSE %{buildroot}/usr/share/package-licenses/samtools/2ec75da78dd85b1626da361c5603db273dac4cd2 || :
cp %{_builddir}/samtools-%{version}/htslib-1.16/htscodecs/LICENSE.md %{buildroot}/usr/share/package-licenses/samtools/6c4957c5b4497597ff61a6a6cef7b08eacbc7731 || :
...
/usr/share/package-licenses/samtools/2ec75da78dd85b1626da361c5603db273dac4cd2
/usr/share/package-licenses/samtools/50cf0fe6339a24d238c57e77aa74deb891080ecd
