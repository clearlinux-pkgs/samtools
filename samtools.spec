...
Source0  : https://github.com/samtools/samtools/releases/download/1.19/samtools-1.19.tar.bz2
...
%prep
%setup -q -n samtools-1.19
cd %{_builddir}/samtools-1.19
pushd ..
cp -a samtools-1.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711743119
...
cp %{_builddir}/samtools-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/samtools/662c048560bab382019b00864c435227bbdd57b7 || :
cp %{_builddir}/samtools-%{version}/htslib-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/samtools/ea8a4f5c9e6ea3725e9c4b0399bdd26094d531f7 || :
...
/usr/share/package-licenses/samtools/662c048560bab382019b00864c435227bbdd57b7
/usr/share/package-licenses/samtools/6c4957c5b4497597ff61a6a6cef7b08eacbc7731
/usr/share/package-licenses/samtools/ea8a4f5c9e6ea3725e9c4b0399bdd26094d531f7
